  ...
  if (isLastStep.value) {
    const submitData = {
      ...
      indexing: {
        ...
        ...(state.indexing?.chunking_strategy.includes('hierarchical') ? { hirearchical_parent_chunk_size: state.indexing?.hirearchical_parent_chunk_size, hirearchical_child_chunk_size: state.indexing?.hirearchical_child_chunk_size, hirearchical_chunk_overlap_percentage: state.indexing?.hirearchical_chunk_overlap_percentage } : {}),
