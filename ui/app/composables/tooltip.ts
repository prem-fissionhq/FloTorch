...
hierarchical_parent_chunk_size: 'Set the size of the parent chunks for hierarchical chunking.',
hierarchical_child_chunk_size: 'Set the size of the child chunks for hierarchical chunking.',
